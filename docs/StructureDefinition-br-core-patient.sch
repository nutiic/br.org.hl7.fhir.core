...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://ips.saude.gov.br/fhir/StructureDefinition/raca-br-ips']) &gt;= 1">extension with URL = 'https://ips.saude.gov.br/fhir/StructureDefinition/raca-br-ips': minimum cardinality of 'extension' is 1</sch:assert>
